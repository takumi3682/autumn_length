...
```
これを1961〜1990年と、1991〜2020年で比較してみる。
...
```
1961〜1990年に比べると、1991〜2020年の分布は全体的に右側（暖候側）にシフトしていることがわかる。
1961〜1990年に比べ、1991〜2020年が「温かい期間」となっていることが確認出来た。

次に、暖候期と寒候期の重ね合わせで2峰型になっているのではないかと予想した。
...
次に、解像度を上げて春・夏・秋・冬の4季に分割してみた。春:3〜5月、夏:6〜8月、秋:9〜11月、冬:12〜2月である。
...
夏については2峰型にも見えること、左側（寒候側）に尾を引いているようにみえる。仮説として海風の影響が考えられる。これは他の地域（日本海側の山形とか？）との比較が必要と考える。
